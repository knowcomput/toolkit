...
interface IconProps {
  name: 'upload' | 'image' | 'download' | 'sparkles' | 'file-code' | 'text-search' | 'arrow-left';
  className?: string;
}
...
const icons: Record<IconProps['name'], React.ReactNode> = {
  ...
  'text-search': (
     <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
       <path strokeLinecap="round" strokeLinejoin="round" d="M3.75 6.75h16.5M3.75 12h16.5m-16.5 5.25H12m-1.48-9.33l-3.26 3.26m0 0l3.26 3.26M6.02 12.74l3.26-3.26m7.46-3.26l3.26 3.26m0 0l-3.26 3.26m3.26-3.26l-3.26-3.26" />
